...
export default function Footer() {
  return (
    <footer className="bg-[#F8F5F0] text-[#2C2C2C] border-t-4 border-[#C9B87A]">
      {/* Header CTA */}
      ...
      <div className="max-w-7xl mx-auto pb-16 px-6 flex flex-col items-center space-y-12">
        ...
        <div className="flex flex-col sm:flex-row gap-8 items-center text-[#2C2C2C] text-base font-medium">
          <div className="flex items-center gap-2 group cursor-pointer">
            ...
            <a href="mailto:info@blacktomato.com" className="hover:text-[#C9B87A] transition-colors">
        ...
        <div className="text-sm text-center text-[#2C2C2C] font-libre">
          <p>
            ...
            <span className="font-semibold hover:text-[#C9B87A] transition-colors">LuxBlack</span> | Developed by{" "}
            <a
