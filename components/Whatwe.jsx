...
export default function Whatwe() {
  return (
    <section className="bg-[#F8F5F0] w-full py-6 md:py-16  px-6 sm:px-10">
      <div className="max-w-7xl mx-auto gap-0 md:gap-4 flex flex-col-reverse lg:flex-row items-center lg:items-stretch">
        {/* Text Section (60%) */}
        ...
        <div className="w-full lg:w-[40%] flex items-center justify-center relative h-[350px] sm:h-[250px]">
          <Image
